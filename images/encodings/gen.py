...
docWriteBMP("gen-windows31-cp1252-system.bmp",loadAndRenderWindowsFNT(raw=WindowsNEResourceReader(path="ref/windows31_system.fon").getResource(resTypeID=8,resID=0x1F).data))
