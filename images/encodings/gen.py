...
from apodlib.docImagePNG import *
...
do_win_ne_fnt_res(source="ref/windows31_sans_serif.fon",    dest="gen-windows31-cp1252-sans-serif-24pt.bmp",   resTypeID=8,resID=0x59)
